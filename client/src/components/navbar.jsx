            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-30 items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-4 lg:space-x-6">
                        <Link
                            to="/"
                            className="text-gray-700 hover:text-gray-900 px-2 py-2 text-sm plus-jakarta-sans-400"
                        >
                            Home
                        </Link>
                        <Link
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        >
                            <button className="bg-[#0B1518] cursor-pointer text-gray-200 px-8 py-2 rounded-xl text-sm plus-jakarta-sans-400">
                                Admin Dashboard
                            </button>
                        </Link>
                    </div>
