        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full md:w-3/4">
            <div className="flex flex-col gap-2">
              ...
              <a href="/" className="text-gray-800 hover:text-gray-900 text-sm">
                Home
              </a>
              <a href="/about-us" className="text-gray-800 hover:text-gray-900 text-sm">
                Inventory
              </a>
              <a href="/faq-blog" className="text-gray-800 hover:text-gray-900 text-sm">
                About Us
              </a>
              <a href="/contact-us" className="text-gray-800 hover:text-gray-900 text-sm">
                FAQ & Blog
              </a>
              <a href="/contact-us" className="text-gray-800 hover:text-gray-900 text-sm">
                Contact Us
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="/products" className="text-gray-800 hover:text-gray-900 text-sm">
                Products & Categories
              </a>
              <a href="/shipping" className="text-gray-800 hover:text-gray-900 text-sm">
                Services
              </a>
              <a href="/how-it-works" className="text-gray-800 hover:text-gray-900 text-sm">
                How it Works
              </a>
              <a href="/track-order" className="text-gray-800 hover:text-gray-900 text-sm">
                Track Order
              </a>
